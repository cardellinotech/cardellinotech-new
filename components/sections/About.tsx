...
export default function About() {
  return (
    <section id="about" className="scroll-mt-[72px] py-[96px] px-4 bg-[var(--color-surface)]">
      <div className="mx-auto max-w-[1200px]">
        <div className="grid grid-cols-1 md:grid-cols-[240px_1fr] gap-12 items-start">
          ...
          <div className="flex flex-col gap-6">
            <h2 className="font-display text-[44px] font-bold leading-[1.1] tracking-[-0.02em] text-[var(--color-on-background)]">
              About
            </h2>
